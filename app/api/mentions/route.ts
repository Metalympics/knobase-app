      ...
      dispatchWebhook(webhookData.webhook_url, webhookData.secret, {
        ...
        knobase_context: {
          ...
          instructions: [
            ...
            "Use update_task_status to report your progress so the user sees live feedback.",
            "Call with status='working' and current_action while processing.",
            "Call with status='completed' and result_summary when done.",
            "",
            "STREAMING EDITS — stream_edit:",
            "Use stream_edit for incremental document edits visible to the user in real-time.",
            "",
